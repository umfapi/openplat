...
|	商户地区	|	mer_area	|	是	|	max(100)	|	【省市区】英文逗号隔开	|
|	商户地区码	|	mer_code	|	是	|	max(15)	|	【省市区】英文逗号隔开	|
...
|	身份证正面	|	img_idfront	|	是	|	图片唯一编号	|		|
|	身份证反面	|	img_idback	|	是	|	图片唯一编号	|		|
|	手持身份证	|	img_idhandle	|	是	|	图片唯一编号	|		|
|	银行卡正面	|	img_cardfront	|	是	|	图片唯一编号	|		|
...
|银行卡收单借记卡T1费率	|	debit_t1_fl	|	是	|		|	如0.55%，传0.55	|
|银行卡收单借记卡T1封顶值	|	debit_t1_fd	|	是	|		|	单位：元	|
|银行卡收单借记卡D0费率	|	debit_d0_fl	|	是	|		|	如0.55%，传0.55	|
|银行卡收单借记卡D0附加费	|	debit_d0_fd	|	是	|	单位：元	|		|
|银行卡收单贷记卡T1费率	|	credit_t1_fl	|	是	|		|	如0.55%，传0.55	|
|银行卡收单贷记卡D0费率	|	credit_d0_fl	|	是	|		|	如0.55%，传0.55	|
|银行卡收单贷记卡D0附加费	|	credit_d0_fj	|	是	|		|	单位：元	|
|云闪付借记卡T1费率	|	yun_debit_t1_fl	|	是	|		|	如0.55%，传0.55	|
|云闪付借记卡D0费率	|	yun_debit_d0_fl	|	是	|		|	如0.55%，传0.55	|
|云闪付贷记卡T1费率	|	yun_credit_t1_fl	|	是	|		|	如0.55%，传0.55	|
|云闪付贷记卡D0费率	|	yun_credit_d0_fl	|	是	|		|	如0.55%，传0.55	|
